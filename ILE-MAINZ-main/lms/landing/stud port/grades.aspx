<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="grades.aspx.cs" Inherits="testingssss.stud_port.dash" %>
            ...
            <div class="side-bar">
                <div class="menu">
                    <div class="item-logo">
                        ...
                        <span id="Label1" class="admin-label">Welcome, </span>
                        <asp:Label ID="lblUserEmail" runat="server" CssClass="admin-label" Text="Michael Verano"></asp:Label>
                    </div>
                    <div class="item">
            ...
            <main class="content">
                <div class="room-page">
                    <div class="room-filter">
                        <div class="filters">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="content-table">
                                <Columns>
