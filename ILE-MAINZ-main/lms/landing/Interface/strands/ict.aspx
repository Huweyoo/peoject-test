<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ict.aspx.cs" Inherits="testingssss.Interface.strand.ict" %>
         ...
         <section class="Course">
            <div class="row">
                <div class="strand-col">
                    <img src="/landing/resources/backsu (4).jpg" class="profe" />
                    <h3>
                        This Strand encompasses a set of college courses tailored to provide focused education and training in <br />information communication technology which are the:
                    </h3>
                    <p>
