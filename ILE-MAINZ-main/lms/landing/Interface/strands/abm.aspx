<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="abm.aspx.cs" Inherits="testingssss.Interface.strand.abm" %>
...
<body>
    ...
    <section class="sub-header">
        <nav>
            <a href="#"><img src="/landing/resources/Log-2.png" /></a>
        ...
        <section class="Course">
            <div class="row">
                <div class="strand-col">
                    <img src="/landing/resources/backsu (1).png" class="profe" />
                    <h3>
                        This Strand encompasses a set of college courses tailored to provide focused education and training in <br />accountancy business management which are the:
                    </h3>
                    <p>
