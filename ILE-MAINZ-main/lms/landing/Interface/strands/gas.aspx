<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gas.aspx.cs" Inherits="testingssss.Interface.strand.gas" %>
         ...
         <section class="Course">
            <div class="row">
                <div class="strand-col">
                    <img src="/landing/resources/backsu (2).jpg" class="profe" />
                    <h3>
                        This Strand encompasses a set of college courses tailored to provide focused education and training in <br />general academic strand disciplines which are the:
                    </h3>
                    <p>
