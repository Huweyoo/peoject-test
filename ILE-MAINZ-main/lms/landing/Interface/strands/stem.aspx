<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="stem.aspx.cs" Inherits="testingssss.Interface.strand.stem" %>
        ...
        <section class="Course">
            <div class="row">
                <div class="strand-col">
                    <img src="/landing/resources/backsu (1).jpg" class="profe" />
                    <h3>
                        This Strand encompasses a set of college courses tailored to provide focused education and training in <br />science, technology, engineering And mathematics disciplines which are the:
                    </h3>
                    <p>
                    ...
                    <p>
                        Bachelor of Science in Earth And Space Science
                    </p>
                    <p>
